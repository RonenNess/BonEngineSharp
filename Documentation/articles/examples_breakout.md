...
This scene implements a simple Breakout game without using any loaded assets. Run this scene from any `BonEngine` application and it will work.

![example_breakout.jpg](../images/example_breakout.jpg)
